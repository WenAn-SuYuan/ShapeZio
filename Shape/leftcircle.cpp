...
int LeftCircle::numInDestination = 0;


LeftCircle::LeftCircle(QWidget *parent)
    : QLabel{parent}
{
    QPixmap pix = scaleImage(":/machine_and_pic /PictureSource/LeftCircle.png", QSize(50, 50));
    setPixmap(pix);
...
QPixmap LeftCircle::scaleImage(const QString &filePath, const QSize &newSize) {
...
bool LeftCircle::moveHere(int m, int n){
...
bool LeftCircle::event(QEvent *e){
