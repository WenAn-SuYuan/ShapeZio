...
RightCircle::RightCircle(QWidget *parent)
    : QLabel{parent}
{

    QPixmap pix = scaleImage(":/machine_and_pic /PictureSource/RightCircle.png", QSize(50, 50));
    setPixmap(pix);
...
QPixmap RightCircle::scaleImage(const QString &filePath, const QSize &newSize) {
...
bool RightCircle::moveHere(int m, int n){
...
bool RightCircle::event(QEvent *e){
