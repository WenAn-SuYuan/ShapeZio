...
struct qt_meta_stringdata_CLASSCircleENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSCircleENDCLASS = QtMocHelpers::stringData(
    "Circle"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSCircleENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Circle::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSCircleENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSCircleENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCircleENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Circle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSCircleENDCLASS.stringdata0))
